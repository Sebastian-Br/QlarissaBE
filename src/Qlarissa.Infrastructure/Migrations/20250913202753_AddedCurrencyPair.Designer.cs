...
namespace Qlarissa.Infrastructure.Migrations
{
    ...
    [Migration("20250913202753_AddedCurrencyPair")]
    partial class AddedCurrencyPair
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qlarissa.Domain.Entities.Securities.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Qlarissa.Domain.Entities.QlarissaUser", b =>
                {
                    b.HasOne("Qlarissa.Domain.Entities.Securities.Currency", "DisplayCurrency")
                        .WithMany()
